...
const Services = () => {
  return (
    <div className="services-container p-8">
      <p className="mb-8 text-lg font-semibold">Welcome to our cutting-edge skin disease analysis platform! We offer a range of services to cater to your dermatological needs:</p>

      <div className="overflow-x-auto">
        <table className="services-table w-full sm:w-3/4 md:w-4/5 lg:w-2/3 border-collapse border border-gray-300">
          ...
          <tbody>
            <tr className="border-t border-gray-300">
              <td className="p-4 text-lg font-semibold">1. AI-Powered Diagnosis</td>
            ...
            <tr className="border-t border-gray-300">
              <td className="p-4 text-lg font-semibold">2. Data Recording for Personalized Insights</td>
            ...
            <tr className="border-t border-gray-300">
              <td className="p-4 text-lg font-semibold">3. Informative Disease Details</td>
